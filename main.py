...
def load_model(dataset = args.dataset,checkpoint = args.checkpoint, load_clf=args.load_clf,type = 'recon'):
...
def train_dae(model_dae, model_clf, model_comb, trainloader,testloader,dae_loss = args.dae_loss, lr = args.lr,
